...
pub type PAIRENABLE_R = crate::FR<bool, bool>;
#[doc = r"Proxy"]
pub struct _PAIRENABLEW<'a> {
    w: &'a mut W,
}
impl<'a> _PAIRENABLEW<'a> {
...
#[doc = r"Reader of the field"]
pub type ONECHANNEL_R = crate::FR<bool, bool>;
#[doc = r"Proxy"]
...
impl W {
    ...
    #[doc = "Bit 0 - Enable for this channel pair.."]
    #[inline(always)]
    pub fn pairenable(&mut self) -> _PAIRENABLEW {
        _PAIRENABLEW { w: self }
    }
    #[doc = "Bit 10 - Single channel mode."]
    #[inline(always)]
