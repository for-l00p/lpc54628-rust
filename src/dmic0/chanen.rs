...
pub type EN_CH0_R = crate::FR<bool, bool>;
#[doc = r"Proxy"]
pub struct _EN_CH0W<'a> {
    w: &'a mut W,
}
impl<'a> _EN_CH0W<'a> {
...
#[doc = r"Reader of the field"]
pub type EN_CH1_R = crate::FR<bool, bool>;
#[doc = r"Proxy"]
pub struct _EN_CH1W<'a> {
    w: &'a mut W,
}
impl<'a> _EN_CH1W<'a> {
    #[doc = r"Sets the field bit"]
...
impl W {
    ...
    #[doc = "Bit 0 - Enable channel 0. When 1, PDM channel 0 is enabled."]
    #[inline(always)]
    pub fn en_ch0(&mut self) -> _EN_CH0W {
        _EN_CH0W { w: self }
    }
    #[doc = "Bit 1 - Enable channel 1. When 1, PDM channel 1 is enabled."]
    #[inline(always)]
    pub fn en_ch1(&mut self) -> _EN_CH1W {
        _EN_CH1W { w: self }
    }
}
