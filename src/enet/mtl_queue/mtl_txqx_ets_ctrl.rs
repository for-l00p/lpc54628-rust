...
pub type AVALG_R = crate::FR<bool, bool>;
#[doc = r"Proxy"]
pub struct _AVALGW<'a> {
    w: &'a mut W,
}
impl<'a> _AVALGW<'a> {
...
#[doc = r"Reader of the field"]
pub type CC_R = crate::FR<bool, bool>;
#[doc = r"Proxy"]
pub struct _CCW<'a> {
    w: &'a mut W,
}
