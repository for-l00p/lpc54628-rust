...
impl super::MTL_RXQX_MISSPKT_OVRFLW_CNT {
...
pub type OVFPKTCNT_R = crate::FR<u16, u16>;
#[doc = r"Proxy"]
pub struct _OVFPKTCNTW<'a> {
    w: &'a mut W,
}
impl<'a> _OVFPKTCNTW<'a> {
...
#[doc = r"Reader of the field"]
pub type OVFCNTOVF_R = crate::FR<bool, bool>;
impl R {
...
impl W {
    ...
    #[doc = "Bits 0:10 - Overflow Packet Counter This field indicates the number of packets discarded by the Ethernet block because of Receive queue overflow."]
    #[inline(always)]
    pub fn ovfpktcnt(&mut self) -> _OVFPKTCNTW {
        _OVFPKTCNTW { w: self }
    }
}
