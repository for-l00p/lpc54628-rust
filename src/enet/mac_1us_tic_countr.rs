...
pub type TIC_1US_CNTR_R = crate::FR<u16, u16>;
#[doc = r"Proxy"]
pub struct _TIC_1US_CNTRW<'a> {
    w: &'a mut W,
}
impl<'a> _TIC_1US_CNTRW<'a> {
...
impl W {
    ...
    #[doc = "Bits 0:11 - 1US TIC Counter The application must program this counter so that the number of clock cycles of CSR clock is 1us."]
    #[inline(always)]
    pub fn tic_1us_cntr(&mut self) -> _TIC_1US_CNTRW {
        _TIC_1US_CNTRW { w: self }
    }
}
