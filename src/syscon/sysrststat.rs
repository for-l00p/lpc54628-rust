...
impl crate::ToBits<bool> for EXTRSTR {
    ...
    fn _bits(&self) -> bool {
        match *self {
            EXTRSTR::NO_RESET_DETECTED => false,
...
impl EXTRST_R {
    ...
    pub fn is_no_reset_detected(&self) -> bool {
        *self == EXTRSTR::NO_RESET_DETECTED
    }
...
impl EXTRSTW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            EXTRSTW::NO_RESET_DETECTED => false,
...
impl<'a> _EXTRSTW<'a> {
    ...
    pub fn no_reset_detected(self) -> &'a mut W {
        self.variant(EXTRSTW::NO_RESET_DETECTED)
    }
    #[doc = "Reset detected. Writing a one clears this reset."]
    #[inline(always)]
...
impl crate::ToBits<bool> for WDTR {
    ...
    fn _bits(&self) -> bool {
        match *self {
            WDTR::NO_WDT_RESET_DETECTED => false,
...
impl WDT_R {
    ...
    pub fn is_no_wdt_reset_detected(&self) -> bool {
        *self == WDTR::NO_WDT_RESET_DETECTED
    }
...
impl WDTW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            WDTW::NO_WDT_RESET_DETECTED => false,
...
impl<'a> _WDTW<'a> {
    ...
    pub fn no_wdt_reset_detected(self) -> &'a mut W {
        self.variant(WDTW::NO_WDT_RESET_DETECTED)
    }
    #[doc = "WDT reset detected. Writing a one clears this reset."]
    #[inline(always)]
...
impl crate::ToBits<bool> for BODR {
    ...
    fn _bits(&self) -> bool {
        match *self {
            BODR::NO_BOD_RESET_DETECTED => false,
...
impl BOD_R {
    ...
    pub fn is_no_bod_reset_detected(&self) -> bool {
        *self == BODR::NO_BOD_RESET_DETECTED
    }
...
impl BODW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            BODW::NO_BOD_RESET_DETECTED => false,
...
impl<'a> _BODW<'a> {
    ...
    pub fn no_bod_reset_detected(self) -> &'a mut W {
        self.variant(BODW::NO_BOD_RESET_DETECTED)
    }
    #[doc = "BOD reset detected. Writing a one clears this reset."]
    #[inline(always)]
...
impl crate::ToBits<bool> for SYSRSTR {
    ...
    fn _bits(&self) -> bool {
        match *self {
            SYSRSTR::NO_SYSTEM_RESET_DETECTED => false,
            SYSRSTR::SYSTEM_RESET_DETECTED => true,
        }
    }
}
#[doc = r"Reader of the field"]
...
impl SYSRSTW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            SYSRSTW::NO_SYSTEM_RESET_DETECTED => false,
            SYSRSTW::SYSTEM_RESET_DETECTED => true,
        }
    }
}
#[doc = r"Proxy"]
...
impl<'a> _SYSRSTW<'a> {
    ...
    pub fn no_system_reset_detected(self) -> &'a mut W {
        self.variant(SYSRSTW::NO_SYSTEM_RESET_DETECTED)
    }
    #[doc = "System reset detected. Writing a one clears this reset."]
    #[inline(always)]
    pub fn system_reset_detected(self) -> &'a mut W {
        self.variant(SYSRSTW::SYSTEM_RESET_DETECTED)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
