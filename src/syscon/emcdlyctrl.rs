...
pub type CMD_DELAY_R = crate::FR<u8, u8>;
#[doc = r"Proxy"]
pub struct _CMD_DELAYW<'a> {
    w: &'a mut W,
}
impl<'a> _CMD_DELAYW<'a> {
...
#[doc = r"Reader of the field"]
pub type FBCLK_DELAY_R = crate::FR<u8, u8>;
#[doc = r"Proxy"]
pub struct _FBCLK_DELAYW<'a> {
    w: &'a mut W,
}
impl<'a> _FBCLK_DELAYW<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
impl W {
    ...
    #[doc = "Bits 0:4 - Programmable delay value for EMC outputs in command delayed mode."]
    #[inline(always)]
    pub fn cmd_delay(&mut self) -> _CMD_DELAYW {
        _CMD_DELAYW { w: self }
    }
    #[doc = "Bits 8:12 - Programmable delay value for the feedback clock that controls input data sampling."]
    #[inline(always)]
    pub fn fbclk_delay(&mut self) -> _FBCLK_DELAYW {
        _FBCLK_DELAYW { w: self }
    }
}
