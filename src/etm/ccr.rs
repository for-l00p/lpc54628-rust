...
pub type NUMBEROFADDRESSCOMPARATORPAIRS_R = crate::FR<u8, u8>;
#[doc = r"Reader of the field"]
pub type NDVC_R = crate::FR<u8, u8>;
#[doc = r"Reader of the field"]
pub type NMMD_R = crate::FR<u8, u8>;
#[doc = r"Reader of the field"]
pub type NC_R = crate::FR<u8, u8>;
#[doc = r"Reader of the field"]
pub type SP_R = crate::FR<bool, bool>;
#[doc = r"Reader of the field"]
pub type NEI_R = crate::FR<u8, u8>;
#[doc = r"Reader of the field"]
pub type NEO_R = crate::FR<u8, u8>;
#[doc = r"Reader of the field"]
pub type FFLP_R = crate::FR<bool, bool>;
#[doc = r"Reader of the field"]
pub type NCIDC_R = crate::FR<u8, u8>;
#[doc = r"Reader of the field"]
pub type TSSBP_R = crate::FR<bool, bool>;
#[doc = r"Reader of the field"]
pub type CMA_R = crate::FR<bool, bool>;
#[doc = r"Reader of the field"]
pub type ETMIDRP_R = crate::FR<bool, bool>;
impl R {
    ...
    #[doc = "Bit 23 - FIFOFULL logic present. The value of this bit is 1, indicating that FIFOFULL logic is present in the ETM. To use FIFOFULL the system must also support the function, as indicated by bit \\[8\\] of ETMSCR."]
    #[inline(always)]
