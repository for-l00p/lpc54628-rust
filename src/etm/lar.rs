...
pub type WRITEACCESSCODE_R = crate::FR<u32, u32>;
#[doc = r"Proxy"]
pub struct _WRITEACCESSCODEW<'a> {
    w: &'a mut W,
}
impl<'a> _WRITEACCESSCODEW<'a> {
...
impl W {
    ...
    #[doc = "Bits 0:31 - Write Access Code. A write of 0xC5ACCE55 enables further write access to this device. An invalid write will have the affect of removing write access."]
    #[inline(always)]
    pub fn write_access_code(&mut self) -> _WRITEACCESSCODEW {
        _WRITEACCESSCODEW { w: self }
    }
}
