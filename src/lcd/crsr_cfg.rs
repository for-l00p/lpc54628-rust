...
pub type CRSRSIZE_R = crate::FR<bool, bool>;
#[doc = r"Proxy"]
pub struct _CRSRSIZEW<'a> {
    w: &'a mut W,
}
impl<'a> _CRSRSIZEW<'a> {
...
#[doc = r"Reader of the field"]
pub type FRAMESYNC_R = crate::FR<bool, bool>;
#[doc = r"Proxy"]
pub struct _FRAMESYNCW<'a> {
    w: &'a mut W,
}
impl<'a> _FRAMESYNCW<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl W {
    ...
    #[doc = "Bit 0 - Cursor size selection."]
    #[inline(always)]
    pub fn crsrsize(&mut self) -> _CRSRSIZEW {
        _CRSRSIZEW { w: self }
    }
    #[doc = "Bit 1 - Cursor frame synchronization type."]
    #[inline(always)]
