...
pub type CRSRON_R = crate::FR<bool, bool>;
#[doc = r"Proxy"]
pub struct _CRSRONW<'a> {
    w: &'a mut W,
}
impl<'a> _CRSRONW<'a> {
...
#[doc = r"Reader of the field"]
pub type CRSRNUM1_0_R = crate::FR<u8, u8>;
#[doc = r"Proxy"]
pub struct _CRSRNUM1_0W<'a> {
    w: &'a mut W,
}
impl<'a> _CRSRNUM1_0W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bit 0 - Cursor enable."]
    #[inline(always)]
    pub fn crsron(&mut self) -> _CRSRONW {
        _CRSRONW { w: self }
    }
    #[doc = "Bits 4:5 - Cursor image number."]
    #[inline(always)]
